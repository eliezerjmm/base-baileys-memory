...
const flowInformacion2 = addKeyword('Si, Ver Certificado')
    ...
    .addAnswer(
        '⭐ *Si no te gusta, te devolvemos el 100% de tu dinero* 👇',
        {
...
const flowSaludo = addKeyword(
    ...
    .addAnswer(
        [
            'Hola! soy Jesús y hago parte del equipo de marketing de @academiasmartphone', '',
...
async function main() {
    ...
    const adapterFlow = createFlow([flowSaludo, flowInformacion1, flowPrecio])
